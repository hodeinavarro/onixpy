...
Requires lxml for RNG validation support.
"""
...
def validate_xml_element(
    ...
    Example:
        >>> from lxml import etree
        >>> from onix.parsers.rng_validator import validate_xml_element
...
def validate_xml_string(
    ...
    Example:
        >>> from onix.parsers.rng_validator import validate_xml_string
...
def validate_xml_file(
    ...
    Example:
        >>> from onix.parsers.rng_validator import validate_xml_file
